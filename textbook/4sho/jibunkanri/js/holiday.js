...
function checkHoliday(year,month,day){
    ...
    let numOfWeek=Math.floor((day-1)/7)+1;//何度目の曜日か
...
function checkFurikae(year,month,day){
    ...
    if(dayOfWeek==2&&furikaeFlag!=true){
        furikaeFlag=checkHoliday(year,month,day-1)&&checkHoliday(year,month,day-2);
    }
    //水曜
    if(dayOfWeek==3&&furikaeFlag!=true){
        furikaeFlag=checkHoliday(year,month,day-1)&&checkHoliday(year,month,day-2)&&checkHoliday(year,month,day-3);
    }
    ...
    if((dayOfWeek!=0&&dayOfWeek!=6)&&furikaeFlag!=true){
        ...
        furikaeFlag=checkHoliday(prevDate.getFullYear(),prevDate.getMonth()+1,prevDate.getDate())&&checkHoliday(nextDate.getFullYear(),nextDate.getMonth()+1,nextDate.getDate())
        {
            return furikaeFlag;
        }
    }
